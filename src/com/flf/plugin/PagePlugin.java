...
public class PagePlugin implements Interceptor {
		...
		if(ivk.getTarget() instanceof RoutingStatementHandler){
			...
			if(mappedStatement.getId().matches(pageSqlId)){ //拦截需要分页的SQL
				...
				if(parameterObject==null){
					...
					String pageSql = generatePageSql(sql,page,mappedStatement.getId());
	 ...
	 * @return
	 */
	private String generatePageSql(String sql,Page page,String mappedStatementId){
		if(page!=null && Tools.notEmpty(dialect)){
			StringBuffer pageSql = new StringBuffer();
			if("mysql".equals(dialect)){
				pageSql.append(sql);
				if(mappedStatementId.contains("listPageBatch")){
