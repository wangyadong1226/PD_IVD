...
WindowPanel.prototype = {
  ...
  init : function(){
    ...
    if(this.dragable){
      this.windowpanel.draggable({ containment: 'parent' });
      this.windowpanel_title.addClass('windowpanel_move');
      this.windowpanel_title.hover(
        function(){
          windowEntity.windowpanel.draggableEnable();
        },
        function(){
          windowEntity.windowpanel.draggableDisable();
        }
      );
    }
